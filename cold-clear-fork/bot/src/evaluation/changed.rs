...
impl Evaluator for Standard {
    type Value = Value;
    type Reward = Reward;
    type Trace = super::standard::EvalTrace;
    ...
    fn pick_move(
        &self,
        candidates: Vec<MoveCandidate<Value, super::standard::EvalTrace>>,
        incoming: u32,
    ) -> MoveCandidate<Value, super::standard::EvalTrace> {
        let mut backup = None;
    ...
    fn evaluate(
        ...
        move_time: u32,
        placed: Piece,
    ) -> (Value, Reward, super::standard::EvalTrace) {
        ...
        (
            ...
            super::standard::EvalTrace::default(),
        )
    }
}
